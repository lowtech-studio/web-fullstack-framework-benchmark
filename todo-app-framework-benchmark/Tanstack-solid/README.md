# TanStack Start – Todo App Benchmark

Todo app built with TanStack Start (Solid) + better-sqlite3. Matches the VanillaJS CSR feature set: list, create, and delete todos from a SQLite database seeded with 10 000 entries.

## Getting Started

```bash
npm install
npm run seed   # initialise the SQLite DB with 10 000 todos
